...
#define CLEAR_TICKER_INT()      T0CLR = 0x0
#define DISABLE_TICKER_INT()    INT_REQ5 = (1<<28)|(1<<27)|(1<<26)|(1<<16)|0x0
#define ENABLE_TICKER_INT()     INT_REQ5 = (1<<28)|(1<<27)|(1<<26)|(1<<16)|0x1

#define TICKER_VEC_NO           5
