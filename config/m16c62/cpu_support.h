...
#if 0
// Old IAR compiler craches on __get_interrupt_state()
# define cpu_store_lock_state()   
# define cpu_restore_lock_state()  cpu_unlock()
#else
# define cpu_store_lock_state()   __state_t cpu_lock_state = __get_interrupt_state()
